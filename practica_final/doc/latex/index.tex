...
{\ttfamily prompt \%$>$ \hyperlink{classconecta4}{conecta4} $<$filas\-\_\-tablero$>$ $<$cols\-\_\-tablero$>$ $<$metrica$>$ $<$turno$>$}
...
\hyperlink{classconecta4}{conecta4}
\begin{DoxyItemize}
\item Makefile
...
\begin{DoxyCode}
prompt% tar zcv \hyperlink{classconecta4}{conecta4}.tgz \hyperlink{classconecta4}{conecta4}
\end{DoxyCode}
 tras lo cual, dispondrá de un nuevo archivo conecta4.\-tgz que contiene la carpeta \hyperlink{classconecta4}{conecta4} así como todas las carpetas y archivos que cuelgan de ella.
